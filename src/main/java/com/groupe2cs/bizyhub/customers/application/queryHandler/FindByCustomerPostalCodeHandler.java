...
import com.groupe2cs.bizyhub.customers.application.query.FindByCustomerPostalCodeQuery;
...
public class FindByCustomerPostalCodeHandler {

	private final CustomerRepository repository;

	@QueryHandler
	public List<CustomerResponse> handle(FindByCustomerPostalCodeQuery query) {
