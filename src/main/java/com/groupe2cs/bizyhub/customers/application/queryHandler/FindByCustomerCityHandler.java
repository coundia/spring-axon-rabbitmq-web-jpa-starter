...
import com.groupe2cs.bizyhub.customers.application.query.FindByCustomerCityQuery;
...
public class FindByCustomerCityHandler {

	private final CustomerRepository repository;

	@QueryHandler
	public List<CustomerResponse> handle(FindByCustomerCityQuery query) {
