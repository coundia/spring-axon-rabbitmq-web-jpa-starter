...
import com.groupe2cs.bizyhub.customers.application.query.FindByCustomerCodeQuery;
...
public class FindByCustomerCodeHandler {

	private final CustomerRepository repository;

	@QueryHandler
	public List<CustomerResponse> handle(FindByCustomerCodeQuery query) {
