...
import com.groupe2cs.bizyhub.customers.application.query.FindByCustomerIsActiveQuery;
...
public class FindByCustomerIsActiveHandler {

	private final CustomerRepository repository;

	@QueryHandler
	public List<CustomerResponse> handle(FindByCustomerIsActiveQuery query) {
