...
import com.groupe2cs.bizyhub.stock.application.query.FindByStockMovementTenantQuery;
...
public class FindByStockMovementTenantHandler {

	private final StockMovementRepository repository;

	@QueryHandler
	public List<StockMovementResponse> handle(FindByStockMovementTenantQuery query) {
