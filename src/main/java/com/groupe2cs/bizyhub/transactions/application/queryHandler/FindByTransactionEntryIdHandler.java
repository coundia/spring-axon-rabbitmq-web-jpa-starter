...
public class FindByTransactionEntryIdHandler {

private final TransactionEntryRepository repository;

@QueryHandler

 public TransactionEntryResponse handle(FindByTransactionEntryIdQuery query) {

    MetaRequest metaRequest = query.getMetaRequest();
    TransactionEntry entity = null;
    ...
    if (entity == null) {
		...
		return TransactionEntryMapper.toResponse(entity);
	}
