...
import com.groupe2cs.bizyhub.transactions.application.query.FindByTransactionRemoteIdQuery;
...
public class FindByTransactionRemoteIdHandler {

	private final TransactionRepository repository;

	@QueryHandler
	public List<TransactionResponse> handle(FindByTransactionRemoteIdQuery query) {
