...
public interface TransactionUserRepository extends JpaRepository<TransactionUser, String> {
	...
	List<TransactionUser> findBySyncAtAndTenantId(Instant syncAt, String tenantId);

    List<TransactionUser> findBySyncAtAndCreatedById(Instant syncAt, String createdById);
}
