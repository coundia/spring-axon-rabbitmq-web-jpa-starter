		...
		try {
			Transaction entity = Transaction.builder()
					...
					.company(event.getCompany() == null ?
							null :
							new com.groupe2cs.bizyhub.companies.infrastructure.entity.Company(event.getCompany()
									.value()))
					.customer(event.getCustomer() == null ?
							null :
							new com.groupe2cs.bizyhub.customers.infrastructure.entity.Customer(event.getCustomer()
									.value()))
					.debt(event.getDebt() == null ?
							null :
							new com.groupe2cs.bizyhub.debts.infrastructure.entity.Debt(event.getDebt().value()))
					.build();
	...
	public void on(TransactionUpdatedEvent event) {
		try {
			...
			if (event.getCompany() != null) {
				entity.setCompany(new com.groupe2cs.bizyhub.companies.infrastructure.entity.Company(event.getCompany()
						.value()));
			}

			if (event.getCustomer() != null) {
				entity.setCustomer(new com.groupe2cs.bizyhub.customers.infrastructure.entity.Customer(event.getCustomer()
						.value()));
			}
