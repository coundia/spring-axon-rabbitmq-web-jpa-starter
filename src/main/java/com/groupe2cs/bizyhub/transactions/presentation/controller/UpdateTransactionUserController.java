...
import com.groupe2cs.bizyhub.transactions.application.usecase.TransactionUserUpdateApplicationService;
	...
	) {
		{
			try {
				...
				TransactionUserResponse
						response =
						applicationService.updateTransactionUser(TransactionUserId.create(id),
								request,
								metaRequest
						);
