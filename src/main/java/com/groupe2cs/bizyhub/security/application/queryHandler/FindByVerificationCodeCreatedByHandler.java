...
import com.groupe2cs.bizyhub.security.application.query.FindByVerificationCodeCreatedByQuery;
...
public class FindByVerificationCodeCreatedByHandler {

	private final VerificationCodeRepository repository;

	@QueryHandler
	public List<VerificationCodeResponse> handle(FindByVerificationCodeCreatedByQuery query) {
