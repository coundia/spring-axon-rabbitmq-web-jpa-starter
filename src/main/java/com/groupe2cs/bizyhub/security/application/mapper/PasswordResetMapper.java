...
PasswordResetToken.create(request.getToken()), PasswordResetUsername.create(request.getUsername()), PasswordResetExpiration.create(request.getExpiration())
);
}
...
id, PasswordResetToken.create(request.getToken()), PasswordResetUsername.create(request.getUsername()), PasswordResetExpiration.create(request.getExpiration())
);
}
