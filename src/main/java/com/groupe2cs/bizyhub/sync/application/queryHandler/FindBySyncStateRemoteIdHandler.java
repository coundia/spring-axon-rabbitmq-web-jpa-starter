...
import com.groupe2cs.bizyhub.sync.application.query.FindBySyncStateRemoteIdQuery;
...
public class FindBySyncStateRemoteIdHandler {

	private final SyncStateRepository repository;

	@QueryHandler
	public List<SyncStateResponse> handle(FindBySyncStateRemoteIdQuery query) {
