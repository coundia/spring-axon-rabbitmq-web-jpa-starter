...
import com.groupe2cs.bizyhub.message.application.query.FindByMessageIsDefaultQuery;
...
public class FindByMessageIsDefaultHandler {

	private final MessageRepository repository;

	@QueryHandler
	public List<MessageResponse> handle(FindByMessageIsDefaultQuery query) {
