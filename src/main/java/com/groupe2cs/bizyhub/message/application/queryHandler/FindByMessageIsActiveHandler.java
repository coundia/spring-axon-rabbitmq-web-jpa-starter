...
import com.groupe2cs.bizyhub.message.application.query.FindByMessageIsActiveQuery;
...
public class FindByMessageIsActiveHandler {

	private final MessageRepository repository;

	@QueryHandler
	public List<MessageResponse> handle(FindByMessageIsActiveQuery query) {
