...
import com.groupe2cs.bizyhub.message.application.query.FindByMessageRemoteIdQuery;
...
public class FindByMessageRemoteIdHandler {

	private final MessageRepository repository;

	@QueryHandler
	public List<MessageResponse> handle(FindByMessageRemoteIdQuery query) {
