...
public interface CategoryRepository extends JpaRepository<Category, String> {
	...
	@Query("SELECT e FROM Category e WHERE e.reference = ?1  ORDER BY e.createdAtAudit DESC limit 1 ")
	Optional<Category> findByReference(String reference);

	@Query("SELECT e FROM Category e WHERE e.reference = ?1 and e.createdBy.id = ?2 ORDER BY e.createdAtAudit DESC limit 1 ")
	Optional<Category> findByReferenceAndCreatedById(String reference, String createdById);
