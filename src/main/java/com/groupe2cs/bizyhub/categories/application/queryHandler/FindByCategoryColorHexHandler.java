...
import com.groupe2cs.bizyhub.categories.application.query.FindByCategoryColorHexQuery;
...
public class FindByCategoryColorHexHandler {

	private final CategoryRepository repository;

	@QueryHandler
	public List<CategoryResponse> handle(FindByCategoryColorHexQuery query) {

		MetaRequest metaRequest = query.getMetaRequest();

		String value = query.getColorHex().value();
		List<Category> entities = repository.findByColorHexAndCreatedById(value, metaRequest.getUserId());
