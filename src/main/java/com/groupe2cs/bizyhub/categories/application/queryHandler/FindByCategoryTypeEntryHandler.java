...
import com.groupe2cs.bizyhub.categories.application.query.FindByCategoryTypeEntryQuery;
...
public class FindByCategoryTypeEntryHandler {

	private final CategoryRepository repository;

	@QueryHandler
	public List<CategoryResponse> handle(FindByCategoryTypeEntryQuery query) {
