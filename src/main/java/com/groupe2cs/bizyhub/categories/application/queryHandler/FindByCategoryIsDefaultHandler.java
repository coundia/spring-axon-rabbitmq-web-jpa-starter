...
import com.groupe2cs.bizyhub.categories.application.query.FindByCategoryIsDefaultQuery;
...
public class FindByCategoryIsDefaultHandler {

	private final CategoryRepository repository;

	@QueryHandler
	public List<CategoryResponse> handle(FindByCategoryIsDefaultQuery query) {

		MetaRequest metaRequest = query.getMetaRequest();

		Boolean value = query.getIsDefault().value();
		List<Category> entities = repository.findByIsDefaultAndCreatedById(value, metaRequest.getUserId());
