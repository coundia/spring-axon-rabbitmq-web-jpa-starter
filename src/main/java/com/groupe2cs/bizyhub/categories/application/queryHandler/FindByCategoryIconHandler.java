...
import com.groupe2cs.bizyhub.categories.application.query.FindByCategoryIconQuery;
...
public class FindByCategoryIconHandler {

	private final CategoryRepository repository;

	@QueryHandler
	public List<CategoryResponse> handle(FindByCategoryIconQuery query) {

		MetaRequest metaRequest = query.getMetaRequest();

		String value = query.getIcon().value();
		List<Category> entities = repository.findByIconAndCreatedById(value, metaRequest.getUserId());
