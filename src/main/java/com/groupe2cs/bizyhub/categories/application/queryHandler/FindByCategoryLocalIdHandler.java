...
import com.groupe2cs.bizyhub.categories.application.query.FindByCategoryLocalIdQuery;
...
public class FindByCategoryLocalIdHandler {

	private final CategoryRepository repository;

	@QueryHandler
	public List<CategoryResponse> handle(FindByCategoryLocalIdQuery query) {
