...
public List<CategoryResponse> findByCategoryStatus(
	CategoryStatus value,
	MetaRequest metaRequest
	) {

	FindByCategoryStatusQuery query = new FindByCategoryStatusQuery(value,metaRequest);
	CompletableFuture<List<CategoryResponse>> future = queryGateway.query(query,
	org.axonframework.messaging.responsetypes.ResponseTypes.multipleInstancesOf(CategoryResponse.class));
	return future.join();
}
public List<CategoryResponse> findByCategoryIsPublic(
	CategoryIsPublic value,
	MetaRequest metaRequest
	) {

	FindByCategoryIsPublicQuery query = new FindByCategoryIsPublicQuery(value,metaRequest);
	CompletableFuture<List<CategoryResponse>> future = queryGateway.query(query,
	org.axonframework.messaging.responsetypes.ResponseTypes.multipleInstancesOf(CategoryResponse.class));
	return future.join();
}
