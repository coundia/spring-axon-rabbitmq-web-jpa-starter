...
@Tag(name = "Category Queries", description = "Endpoints for listing paginated categories")
public class CategoryListController {
	...
	@GetMapping
	@Operation(
			summary = "List paginated categories",
			description = "Returns a paginated list of categories based on page and limit parameters"
	)
	@ApiResponses(value = {
			@ApiResponse(
					responseCode = "200",
