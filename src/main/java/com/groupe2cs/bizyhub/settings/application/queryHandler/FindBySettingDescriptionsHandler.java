...
public class FindBySettingDescriptionsHandler {

private final SettingRepository repository;
@QueryHandler
public List<SettingResponse> handle(FindBySettingDescriptionsQuery query) {

	 MetaRequest metaRequest = query.getMetaRequest();

String value = query.getDescriptions().value();
	List<Setting> entities = repository.findByDescriptionsAndCreatedById(value, metaRequest.getUserId());
