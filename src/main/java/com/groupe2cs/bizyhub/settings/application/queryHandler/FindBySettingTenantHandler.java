...
import com.groupe2cs.bizyhub.settings.application.query.FindBySettingTenantQuery;
...
public class FindBySettingTenantHandler {
	...
	public List<SettingResponse> handle(FindBySettingTenantQuery query) {
		...
		List<Setting> entities = repository.findByTenantIdAndCreatedById(value, metaRequest.getUserId());
