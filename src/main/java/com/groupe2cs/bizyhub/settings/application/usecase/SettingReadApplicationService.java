...
public class SettingReadApplicationService {
	...
	public List<SettingResponse> findBySettingRemoteId(
			SettingRemoteId value,
			MetaRequest metaRequest
	) {

		FindBySettingRemoteIdQuery query = new FindBySettingRemoteIdQuery(value, metaRequest);
		CompletableFuture<List<SettingResponse>> future = queryGateway.query(query,
				org.axonframework.messaging.responsetypes.ResponseTypes.multipleInstancesOf(SettingResponse.class));
		return future.join();
	}

	public List<SettingResponse> findBySettingLocalId(
			SettingLocalId value,
			MetaRequest metaRequest
	) {

		FindBySettingLocalIdQuery query = new FindBySettingLocalIdQuery(value, metaRequest);
		CompletableFuture<List<SettingResponse>> future = queryGateway.query(query,
				org.axonframework.messaging.responsetypes.ResponseTypes.multipleInstancesOf(SettingResponse.class));
		return future.join();
	}

	public List<SettingResponse> findBySettingAccount(
			SettingAccount value,
			MetaRequest metaRequest
	) {

		FindBySettingAccountQuery query = new FindBySettingAccountQuery(value, metaRequest);
		CompletableFuture<List<SettingResponse>> future = queryGateway.query(query,
				org.axonframework.messaging.responsetypes.ResponseTypes.multipleInstancesOf(SettingResponse.class));
		return future.join();
	}
	...
	public List<SettingResponse> findBySettingSyncAt(
			SettingSyncAt value,
			MetaRequest metaRequest
	) {

		FindBySettingSyncAtQuery query = new FindBySettingSyncAtQuery(value, metaRequest);
		CompletableFuture<List<SettingResponse>> future = queryGateway.query(query,
				org.axonframework.messaging.responsetypes.ResponseTypes.multipleInstancesOf(SettingResponse.class));
		return future.join();
	}
