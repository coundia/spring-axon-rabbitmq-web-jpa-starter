...
import com.groupe2cs.bizyhub.products.application.query.FindByProductStatusesQuery;
...
public class FindByProductStatusesHandler {

	private final ProductRepository repository;

	@QueryHandler
	public List<ProductResponse> handle(FindByProductStatusesQuery query) {
