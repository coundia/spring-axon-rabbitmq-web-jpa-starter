...
import com.groupe2cs.bizyhub.order.application.query.FindByOrderCreatedByQuery;
...
public class FindByOrderCreatedByHandler {

	private final OrderRepository repository;

	@QueryHandler
	public List<OrderResponse> handle(FindByOrderCreatedByQuery query) {
