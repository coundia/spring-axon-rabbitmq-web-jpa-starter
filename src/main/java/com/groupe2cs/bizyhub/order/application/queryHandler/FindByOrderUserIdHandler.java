...
import com.groupe2cs.bizyhub.order.application.query.FindByOrderUserIdQuery;
...
public class FindByOrderUserIdHandler {

	private final OrderRepository repository;

	@QueryHandler
	public List<OrderResponse> handle(FindByOrderUserIdQuery query) {

		MetaRequest metaRequest = query.getMetaRequest();
		List<Order> entities = null;
		String value = query.getUserId().value();
