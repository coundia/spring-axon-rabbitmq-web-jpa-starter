...
@Tag(name = "Order Queries", description = "Endpoints for listing paginated orders")
public class OrderListController {

	private final OrderReadApplicationService applicationService;

	public OrderListController(OrderReadApplicationService applicationService) {
	...
	@Operation(
			...
			description = "Returns a paginated list of orders based on page and limit parameters"
	)
	@ApiResponses(value = {
			@ApiResponse(
					responseCode = "200",
					description = "Successfully retrieved list of orders",
					content = @Content(mediaType = "application/json", schema = @Schema(implementation = OrderPagedResponse.class))
			),
			@ApiResponse(
					responseCode = "500",
	...
	public OrderPagedResponse list(
