...
@Tag(name = "Company Queries", description = "Endpoints for listing paginated companies")
...
@GetMapping
@Operation(
summary = "List paginated companies",
description = "Returns a paginated list of companies based on page and limit parameters"
)
@ApiResponses(value = {
@ApiResponse(
responseCode = "200",
