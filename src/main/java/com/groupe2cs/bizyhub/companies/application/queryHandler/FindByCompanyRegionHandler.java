...
import com.groupe2cs.bizyhub.companies.application.query.FindByCompanyRegionQuery;
...
public class FindByCompanyRegionHandler {

	private final CompanyRepository repository;

	@QueryHandler
	public List<CompanyResponse> handle(FindByCompanyRegionQuery query) {
