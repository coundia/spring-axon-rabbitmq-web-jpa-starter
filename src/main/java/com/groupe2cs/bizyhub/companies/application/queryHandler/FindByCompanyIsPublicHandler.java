...
import com.groupe2cs.bizyhub.companies.application.query.FindByCompanyIsPublicQuery;
...
public class FindByCompanyIsPublicHandler {

	private final CompanyRepository repository;

	@QueryHandler
	public List<CompanyResponse> handle(FindByCompanyIsPublicQuery query) {
