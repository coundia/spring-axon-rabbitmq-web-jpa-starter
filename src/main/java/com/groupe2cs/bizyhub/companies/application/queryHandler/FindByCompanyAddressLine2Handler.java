...
import com.groupe2cs.bizyhub.companies.application.query.FindByCompanyAddressLine2Query;
...
public class FindByCompanyAddressLine2Handler {

	private final CompanyRepository repository;

	@QueryHandler
	public List<CompanyResponse> handle(FindByCompanyAddressLine2Query query) {
