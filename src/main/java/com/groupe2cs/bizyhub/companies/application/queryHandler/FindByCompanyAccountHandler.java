...
import com.groupe2cs.bizyhub.companies.application.query.FindByCompanyAccountQuery;
...
public class FindByCompanyAccountHandler {

	private final CompanyRepository repository;

	@QueryHandler
	public List<CompanyResponse> handle(FindByCompanyAccountQuery query) {
