...
import com.groupe2cs.bizyhub.companies.application.query.FindByCompanySyncAtQuery;
...
public class FindByCompanySyncAtHandler {

	private final CompanyRepository repository;

	@QueryHandler
	public List<CompanyResponse> handle(FindByCompanySyncAtQuery query) {
