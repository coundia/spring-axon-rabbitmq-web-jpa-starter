...
import com.groupe2cs.bizyhub.companies.application.query.FindByCompanyCurrencyQuery;
...
public class FindByCompanyCurrencyHandler {

	private final CompanyRepository repository;

	@QueryHandler
	public List<CompanyResponse> handle(FindByCompanyCurrencyQuery query) {
