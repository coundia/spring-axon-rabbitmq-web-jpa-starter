...
@RestController
@RequestMapping("/api/v1/queries/units")
@Tag(name = "Unit Queries", description = "Endpoints for listing paginated units")
public class UnitListController {

private final UnitReadApplicationService applicationService;

public UnitListController(UnitReadApplicationService  applicationService) {
...
@GetMapping
@Operation(
summary = "List paginated units",
description = "Returns a paginated list of units based on page and limit parameters"
)
@ApiResponses(value = {
@ApiResponse(
responseCode = "200",
description = "Successfully retrieved list of units",
content = @Content(mediaType = "application/json", schema = @Schema(implementation = UnitPagedResponse.class))
),
@ApiResponse(
responseCode = "500",
