...
import com.groupe2cs.bizyhub.accounts.application.query.FindByAccountUserPhoneQuery;
...
public class FindByAccountUserPhoneHandler {

	private final AccountUserRepository repository;

	@QueryHandler
	public List<AccountUserResponse> handle(FindByAccountUserPhoneQuery query) {
