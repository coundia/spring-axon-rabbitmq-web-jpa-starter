...
import com.groupe2cs.bizyhub.accounts.application.query.FindByAccountUserEmailQuery;
...
public class FindByAccountUserEmailHandler {

	private final AccountUserRepository repository;

	@QueryHandler
	public List<AccountUserResponse> handle(FindByAccountUserEmailQuery query) {
