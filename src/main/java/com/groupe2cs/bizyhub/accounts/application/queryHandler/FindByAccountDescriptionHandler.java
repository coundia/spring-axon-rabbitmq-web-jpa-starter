...
import com.groupe2cs.bizyhub.accounts.application.query.FindByAccountDescriptionQuery;
...
public class FindByAccountDescriptionHandler {

	private final AccountRepository repository;

	@QueryHandler
	public List<AccountResponse> handle(FindByAccountDescriptionQuery query) {
