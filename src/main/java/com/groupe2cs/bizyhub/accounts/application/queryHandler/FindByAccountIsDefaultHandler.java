...
import com.groupe2cs.bizyhub.accounts.application.query.FindByAccountIsDefaultQuery;
...
public class FindByAccountIsDefaultHandler {

	private final AccountRepository repository;

	@QueryHandler
	public List<AccountResponse> handle(FindByAccountIsDefaultQuery query) {
