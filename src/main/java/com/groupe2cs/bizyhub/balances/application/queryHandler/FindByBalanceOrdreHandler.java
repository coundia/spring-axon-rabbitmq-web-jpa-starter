...
import com.groupe2cs.bizyhub.balances.application.query.FindByBalanceOrdreQuery;
...
public class FindByBalanceOrdreHandler {
	...
	public List<BalanceResponse> handle(FindByBalanceOrdreQuery query) {
		...
		List<Balance> entities = repository.findByOrdreAndCreatedById(value, metaRequest.getUserId());
