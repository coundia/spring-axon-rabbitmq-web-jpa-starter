...
import com.groupe2cs.bizyhub.balances.application.query.FindByBalanceIsArchivedQuery;
...
public class FindByBalanceIsArchivedHandler {
	...
	public List<BalanceResponse> handle(FindByBalanceIsArchivedQuery query) {
		...
		List<Balance> entities = repository.findByIsArchivedAndCreatedById(value, metaRequest.getUserId());
