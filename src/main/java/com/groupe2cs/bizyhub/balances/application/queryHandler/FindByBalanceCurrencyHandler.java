...
import com.groupe2cs.bizyhub.balances.application.query.FindByBalanceCurrencyQuery;
...
public class FindByBalanceCurrencyHandler {
	...
	public List<BalanceResponse> handle(FindByBalanceCurrencyQuery query) {
		...
		List<Balance> entities = repository.findByCurrencyAndCreatedById(value, metaRequest.getUserId());
