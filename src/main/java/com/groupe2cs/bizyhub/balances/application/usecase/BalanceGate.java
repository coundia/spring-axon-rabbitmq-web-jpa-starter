...
public class BalanceGate {
	...
	public boolean canRead(Authentication auth, String objectId) {
		...
		log.info("canRead result for user {}: owner={}, sameTenant={}, final={} for Balance {}",
				currentUserId,
				owner,
				sameTenant,
				result,
	...
	public boolean canEdit(Authentication auth, String objectId) {
		...
		log.info("canEdit result for user {} on Balance {}: {}",
	...
	public boolean canDelete(Authentication auth, String objectId) {
		...
		boolean result = canRead(auth, objectId);
		log.info("canDelete result for user {} on Balance {}: {}",
				auth != null ? auth.getName() : null,
				objectId,
				result);
		return result;
