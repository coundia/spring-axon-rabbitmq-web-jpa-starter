...
import com.groupe2cs.bizyhub.balances.application.query.FindByBalanceIsAllowDebitQuery;
...
public class FindByBalanceIsAllowDebitHandler {
	...
	public List<BalanceResponse> handle(FindByBalanceIsAllowDebitQuery query) {
		...
		List<Balance> entities = repository.findByIsAllowDebitAndCreatedById(value, metaRequest.getUserId());
