...
import com.groupe2cs.bizyhub.balances.application.query.FindByBalanceLastUpdatedQuery;
...
public class FindByBalanceLastUpdatedHandler {
	...
	public List<BalanceResponse> handle(FindByBalanceLastUpdatedQuery query) {
		...
		List<Balance> entities = repository.findByLastUpdatedAndCreatedById(value, metaRequest.getUserId());
