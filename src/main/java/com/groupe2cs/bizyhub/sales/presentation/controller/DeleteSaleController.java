...
import com.groupe2cs.bizyhub.sales.application.usecase.SaleDeleteApplicationService;
...
public class DeleteSaleController {
    ...
    public ResponseEntity<String> deleteSale(
            @Parameter(description = "ID of the sale to delete", required = true) @PathVariable
            String id) {
