...
public class SaleProjection {
	...
	public void on(SaleCreatedEvent event) {
		try {
			Sale entity = Sale.builder()
					...
					.product(new com.groupe2cs.bizyhub.products.infrastructure.entity.Product(event.getProduct()
							.value()))
	...
	public void on(SaleUpdatedEvent event) {
		try {
			...
			entity.setProduct(new com.groupe2cs.bizyhub.products.infrastructure.entity.Product(event.getProduct()
					.value()));
