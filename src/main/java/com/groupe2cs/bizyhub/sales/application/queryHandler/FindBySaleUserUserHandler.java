...
public class FindBySaleUserUserHandler {

private final SaleUserRepository repository;
@QueryHandler
public List<SaleUserResponse> handle(FindBySaleUserUserQuery query) {

	 MetaRequest metaRequest = query.getMetaRequest();

String value = query.getUser().value();
	List<SaleUser> entities = repository.findByUserIdAndCreatedById(value, metaRequest.getUserId());
