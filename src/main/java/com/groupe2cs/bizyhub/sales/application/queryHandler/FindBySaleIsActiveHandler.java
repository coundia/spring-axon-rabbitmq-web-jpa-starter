...
public class FindBySaleIsActiveHandler {

private final SaleRepository repository;
@QueryHandler
public List<SaleResponse> handle(FindBySaleIsActiveQuery query) {

	 MetaRequest metaRequest = query.getMetaRequest();

Boolean value = query.getIsActive().value();
	List<Sale> entities = repository.findByIsActiveAndCreatedById(value, metaRequest.getUserId());
