...
public class FindBySaleUserIsActiveHandler {

private final SaleUserRepository repository;
@QueryHandler
public List<SaleUserResponse> handle(FindBySaleUserIsActiveQuery query) {

	 MetaRequest metaRequest = query.getMetaRequest();

Boolean value = query.getIsActive().value();
	List<SaleUser> entities = repository.findByIsActiveAndCreatedById(value, metaRequest.getUserId());
