...
public class FindBySaleUserSalesHandler {

private final SaleUserRepository repository;
@QueryHandler
public List<SaleUserResponse> handle(FindBySaleUserSalesQuery query) {

	 MetaRequest metaRequest = query.getMetaRequest();

String value = query.getSales().value();
	List<SaleUser> entities = repository.findBySalesIdAndCreatedById(value, metaRequest.getUserId());
