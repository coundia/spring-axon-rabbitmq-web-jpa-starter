...
return SaleUserResponse.builder()
		.id(entity.getId())
		.name(entity.getName())
		.sale(entity.getSale() != null ? entity.getSale().getId() : null)
...
return CreateSaleUserCommand.builder()
	...
	.sale(SaleUserSale.create(request.getSale()))
	.user(SaleUserUser.create(request.getUser()))
