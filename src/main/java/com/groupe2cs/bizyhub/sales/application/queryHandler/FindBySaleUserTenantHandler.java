...
public class FindBySaleUserTenantHandler {

private final SaleUserRepository repository;
@QueryHandler
public List<SaleUserResponse> handle(FindBySaleUserTenantQuery query) {

	 MetaRequest metaRequest = query.getMetaRequest();

String value = query.getTenant().value();
	List<SaleUser> entities = repository.findByTenantIdAndCreatedById(value, metaRequest.getUserId());
