...
void it_should_create_user_with_valid_values() {
	...
	UserLimitPerDay limitPerDay = UserLimitPerDay.create(88);
	...
	UserAggregate aggregateUserAggregate = new UserAggregate(id, username, password, firstName, lastName, email, telephone, limitPerDay, isPremium, enabled, isBan, message, createdBy, tenant);
