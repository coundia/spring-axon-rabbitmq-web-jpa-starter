...
public class VerificationCodeAggregateTests extends BaseUnitTests {
	...
	void it_should_create_verificationCode_with_valid_values() {
		...
		VerificationCodeAggregate
				aggregateVerificationCodeAggregate =
				new VerificationCodeAggregate(id,
						notes,
						token,
						username,
						phone,
	...
	void it_should_throw_when_id_is_invalid() {
		VerificationCodeIdNotValid
				error =
				assertThrows(VerificationCodeIdNotValid.class, () -> VerificationCodeId.create(""));
