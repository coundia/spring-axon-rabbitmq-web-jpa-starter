...
CreatePasswordResetCommand command = new CreatePasswordResetCommand(
 PasswordResetId.create(UUID.randomUUID().toString()) ,  PasswordResetToken.create(UUID.randomUUID().toString()) ,  PasswordResetUsername.create(UUID.randomUUID().toString()) ,  PasswordResetExpiration.create(java.time.Instant.now().plusSeconds(3600)) 
);
...
PasswordResetCreatedEvent event = new PasswordResetCreatedEvent( PasswordResetId.create(UUID.randomUUID().toString()),  PasswordResetToken.create(UUID.randomUUID().toString()),  PasswordResetUsername.create(UUID.randomUUID().toString()),  PasswordResetExpiration.create(java.time.Instant.now().plusSeconds(3600)));
