...
CreateRolePermissionCommand command = new CreateRolePermissionCommand(
 RolePermissionId.create(UUID.randomUUID().toString()) ,  RolePermissionRole.create(UUID.randomUUID().toString()) ,  RolePermissionPermission.create(UUID.randomUUID().toString()) 
);
...
RolePermissionCreatedEvent event = new RolePermissionCreatedEvent( RolePermissionId.create(UUID.randomUUID().toString()),  RolePermissionRole.create(UUID.randomUUID().toString()),  RolePermissionPermission.create(UUID.randomUUID().toString()));
