...
CreatePermissionCommand command = new CreatePermissionCommand(
 PermissionId.create(UUID.randomUUID().toString()) ,  PermissionName.create(UUID.randomUUID().toString()) ,  PermissionCreatedBy.create(UUID.randomUUID().toString()) ,  PermissionTenant.create(UUID.randomUUID().toString()) 
);
