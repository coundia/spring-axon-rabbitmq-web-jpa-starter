...
CreateApiKeyCommand command = new CreateApiKeyCommand(
 ApiKeyId.create(UUID.randomUUID().toString()) ,  ApiKeyKey.create(UUID.randomUUID().toString()) ,  ApiKeyUsername.create(UUID.randomUUID().toString()) ,  ApiKeyCreatedAt.create(java.time.Instant.now().plusSeconds(3600)) ,  ApiKeyExpiration.create(java.time.Instant.now().plusSeconds(3600)) 
);
...
ApiKeyCreatedEvent event = new ApiKeyCreatedEvent( ApiKeyId.create(UUID.randomUUID().toString()),  ApiKeyKey.create(UUID.randomUUID().toString()),  ApiKeyUsername.create(UUID.randomUUID().toString()),  ApiKeyCreatedAt.create(java.time.Instant.now().plusSeconds(3600)),  ApiKeyExpiration.create(java.time.Instant.now().plusSeconds(3600)));
