...
CreateUserCommand command = new CreateUserCommand(
 UserId.create(UUID.randomUUID().toString()) ,  UserUsername.create(UUID.randomUUID().toString()) ,  UserPassword.create(UUID.randomUUID().toString()) 
);
...
UserCreatedEvent event = new UserCreatedEvent( UserId.create(UUID.randomUUID().toString()),  UserUsername.create(UUID.randomUUID().toString()),  UserPassword.create(UUID.randomUUID().toString()));
