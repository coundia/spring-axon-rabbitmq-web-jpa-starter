...
CreateUserRoleCommand command = new CreateUserRoleCommand(
 UserRoleId.create(UUID.randomUUID().toString()) ,  UserRoleUser.create(UUID.randomUUID().toString()) ,  UserRoleRole.create(UUID.randomUUID().toString()) ,  UserRoleCreatedBy.create(UUID.randomUUID().toString()) ,  UserRoleTenant.create(UUID.randomUUID().toString()) 
);
