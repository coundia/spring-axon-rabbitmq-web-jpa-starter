...
CreateRoleCommand command = new CreateRoleCommand(
 RoleId.create(UUID.randomUUID().toString()) ,  RoleName.create(UUID.randomUUID().toString()) ,  RoleCreatedBy.create(UUID.randomUUID().toString()) ,  RoleTenant.create(UUID.randomUUID().toString()) 
);
