...
public class CategoryAggregateTests extends BaseUnitTests {
	...
	void it_should_throw_when_typeCategoryRaw_is_invalid() {
		CategoryTypeCategoryRawNotValid
				error =
				assertThrows(CategoryTypeCategoryRawNotValid.class, () -> CategoryTypeCategoryRaw.create(""));
	...
	void it_should_throw_when_isActive_is_invalid() {
		CategoryIsActiveNotValid
				error =
				assertThrows(CategoryIsActiveNotValid.class, () -> CategoryIsActive.create(null));
		assertThat(error.getMessage()).isEqualTo("IsActive is invalid");
	}

	@Test
	void it_should_throw_when_updatedAt_is_invalid() {
		CategoryUpdatedAtNotValid
				error =
				assertThrows(CategoryUpdatedAtNotValid.class, () -> CategoryUpdatedAt.create(null));
		assertThat(error.getMessage()).isEqualTo("UpdatedAt is invalid");
	}

	@Test
	void it_should_throw_when_reference_is_invalid() {
		CategoryReferenceNotValid
				error =
				assertThrows(CategoryReferenceNotValid.class, () -> CategoryReference.create(""));
