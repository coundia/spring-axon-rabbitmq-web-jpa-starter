...
void it_should_create_category_with_valid_values() {
	...
	CategoryVersion version = CategoryVersion.create(40);
	...
	CategoryAggregate aggregateCategoryAggregate = new CategoryAggregate(id, code, name, remoteId, localId, account, description, typeEntry, version, syncAt, createdBy, tenant);
