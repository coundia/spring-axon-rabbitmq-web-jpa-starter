...
public static List<CreateSaleCommand> randomManyViaCommand(CommandGateway commandGateway, int count,CustomUser user) {
	List<CreateSaleCommand> items = new ArrayList<>();
		...
		public static CreateSaleCommand randomOneViaCommand(CommandGateway commandGateway, CustomUser user) {



			CreateSaleCommand command = CreateSaleCommand.builder()
				.name(SaleName.create(UUID.randomUUID().toString()))
				.amount(SaleAmount.create(908.22))
