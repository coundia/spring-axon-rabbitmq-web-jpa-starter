...
class SaleUserFindAllControllerIntegrationTest extends BaseIntegrationTests {
...
login("user", "user");
ResponseEntity<SaleUserPagedResponse> response = this.getForEntity(
"/v1/queries/saleUsers?page=0&limit=1000000",
SaleUserPagedResponse.class
);

assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
List<SaleUserResponse> content = response.getBody().getContent();
