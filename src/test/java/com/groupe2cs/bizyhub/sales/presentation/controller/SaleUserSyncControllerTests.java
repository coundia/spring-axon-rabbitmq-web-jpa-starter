...
import com.groupe2cs.bizyhub.sales.application.dto.SaleUserDeltaDto;
...
public class SaleUserSyncControllerTests extends BaseIntegrationTests {
		...
		SaleUserSyncRequest requestDTO = SaleUserSyncRequest.builder()
				.deltas(List.of(
						SaleUserDeltaDto.builder()
								.sales(com.groupe2cs.bizyhub.sales.infrastructure.entity.SaleFixtures.randomOneViaCommand(
										commandGateway,
										salesDataRepository,
										user).getId().value())
								.users(com.groupe2cs.bizyhub.security.infrastructure.entity.UserFixtures.randomOneViaCommand(
										commandGateway,
										usersDataRepository,
										user).getId().value())
	...
	void it_should_initiate_update_of_saleusers() {
		...
		String
				existingId =
				SaleUserFixtures.randomOneViaCommand(commandGateway, Repository, getCurrentUser()).getId().value();
