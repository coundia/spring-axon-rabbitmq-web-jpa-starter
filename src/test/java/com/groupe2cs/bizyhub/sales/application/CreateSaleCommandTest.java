...
public class CreateSaleCommandTest extends BaseUnitTests {
    ...
    void it_should_send_command_to_command_gateway() {
        CreateSaleCommand command = new CreateSaleCommand(
                SaleId.create("test"), SaleQuantity.create(42), SaleTotal_price.create(99.99), SaleFacture.create("test"), SaleProduct.create("test")
        );
        ...
        assertThat(sentCommand.getProduct().value()).isEqualTo("test");
    }

    @Test
    void test_event_serialization() throws JsonProcessingException {
        SaleCreatedEvent event = new SaleCreatedEvent(SaleId.create("test"), SaleQuantity.create(42), SaleTotal_price.create(99.99), SaleFacture.create("test"), SaleProduct.create("test"));
