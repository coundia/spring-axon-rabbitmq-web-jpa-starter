...
import com.groupe2cs.bizyhub.stock.application.dto.StockLevelDeltaDto;
...
public class StockLevelSyncControllerTests extends BaseIntegrationTests {
	...
	void it_should_initiate_update_of_stockLevels() {
		...
		String
				existingId =
				StockLevelFixtures.randomOneViaCommand(commandGateway, Repository, getCurrentUser()).getId().value();
