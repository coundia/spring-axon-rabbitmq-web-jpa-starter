...
void it_should_create_stockMovement_with_valid_values() {
	...
	StockMovementQuantity quantity = StockMovementQuantity.create(91);
	...
	StockMovementAggregate aggregateStockMovementAggregate = new StockMovementAggregate(id, typeStockMovement, quantity, company, syncAt, productVariant, orderLineId, discriminator, createdBy, tenant);
