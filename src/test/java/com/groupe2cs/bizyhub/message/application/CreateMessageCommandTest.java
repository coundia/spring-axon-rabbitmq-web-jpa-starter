...
CreateMessageCommand command = new CreateMessageCommand(
 MessageId.create(UUID.randomUUID().toString()) ,  MessageCode.create(UUID.randomUUID().toString()) ,  MessageEmail.create(UUID.randomUUID().toString()) ,  MessagePhone.create(UUID.randomUUID().toString()) ,  MessageContent.create(UUID.randomUUID().toString()) ,  MessagePlateforme.create(UUID.randomUUID().toString()) ,  MessageSource.create(UUID.randomUUID().toString()) ,  MessageAgent.create(UUID.randomUUID().toString()) ,  MessageStatus.create(UUID.randomUUID().toString()) ,  MessageDescription.create(UUID.randomUUID().toString()) ,  MessageIsActive.create(true) ,  MessageIsDefault.create(false) ,  MessageRemoteId.create(UUID.randomUUID().toString()) ,  MessageLocalId.create(UUID.randomUUID().toString()) ,  MessageDepotAt.create(java.time.Instant.now().plusSeconds(3600)) ,  MessageSyncAt.create(java.time.Instant.now().plusSeconds(3600)) ,  MessageCreatedBy.create(UUID.randomUUID().toString()) ,  MessageTenant.create(UUID.randomUUID().toString()) 
);
