...
void it_should_create_changeLog_with_valid_values() {
	...
	ChangeLogAggregate aggregateChangeLogAggregate = new ChangeLogAggregate(id, entityTable, account, remoteId, localId, operation, payload, status, syncAt, attempts, error, createdBy, tenant);
