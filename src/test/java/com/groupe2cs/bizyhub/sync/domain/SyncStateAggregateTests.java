...
void it_should_create_syncState_with_valid_values() {
	...
	SyncStateAggregate aggregateSyncStateAggregate = new SyncStateAggregate(id, entityTable, remoteId, localId, account, syncAt, lastSyncAt, lastCursor, createdBy, tenant);
	...
	assertThat(aggregateSyncStateAggregate.getTenant()).isEqualTo(tenant);
		...
		SyncStateEntityTableNotValid error = assertThrows(SyncStateEntityTableNotValid.class, () -> SyncStateEntityTable.create(""));
