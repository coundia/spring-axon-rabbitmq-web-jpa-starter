...
import com.groupe2cs.bizyhub.sync.application.dto.ChangeLogDeltaDto;
...
public class ChangeLogSyncControllerTests extends BaseIntegrationTests {
	...
	void it_should_initiate_update_of_changeLogs() {
		...
		String
				existingId =
				ChangeLogFixtures.randomOneViaCommand(commandGateway, Repository, getCurrentUser()).getId().value();
