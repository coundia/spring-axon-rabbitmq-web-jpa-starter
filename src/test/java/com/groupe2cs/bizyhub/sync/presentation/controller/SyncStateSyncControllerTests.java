...
import com.groupe2cs.bizyhub.sync.application.dto.SyncStateDeltaDto;
...
public class SyncStateSyncControllerTests extends BaseIntegrationTests {
	...
	void it_should_initiate_update_of_syncStates() {
		...
		String
				existingId =
				SyncStateFixtures.randomOneViaCommand(commandGateway, Repository, getCurrentUser()).getId().value();
