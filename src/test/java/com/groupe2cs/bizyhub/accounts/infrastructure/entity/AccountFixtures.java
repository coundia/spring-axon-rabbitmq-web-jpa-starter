        ...
        TenantRepository tenantDataRepository,
		 User user) {
			...
			CreateAccountCommand command = CreateAccountCommand.builder()
				...
				.balance(AccountBalance.create(2988.91))
				.balancePrev(AccountBalancePrev.create(2249.87))
				.balanceBlocked(AccountBalanceBlocked.create(7010.81))
				.balanceInit(AccountBalanceInit.create(9285.63))
				.balanceGoal(AccountBalanceGoal.create(715.67))
				.balanceLimit(AccountBalanceLimit.create(2004.12))
