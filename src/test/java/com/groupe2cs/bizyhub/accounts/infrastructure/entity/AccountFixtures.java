        ...
        TenantRepository tenantDataRepository,
		 User user) {
			...
			CreateAccountCommand command = CreateAccountCommand.builder()
				...
				.balance(AccountBalance.create(5735.43))
				.balancePrev(AccountBalancePrev.create(5335.19))
				.balanceBlocked(AccountBalanceBlocked.create(1552.77))
				.balanceInit(AccountBalanceInit.create(5493.17))
				.balanceGoal(AccountBalanceGoal.create(7349.15))
				.balanceLimit(AccountBalanceLimit.create(2889.7))
