        ...
        TenantRepository tenantDataRepository,
		 User user) {
			...
			CreateAccountCommand command = CreateAccountCommand.builder()
				...
				.balance(AccountBalance.create(4942.64))
				.balancePrev(AccountBalancePrev.create(5105.86))
				.balanceBlocked(AccountBalanceBlocked.create(4412.55))
				.balanceInit(AccountBalanceInit.create(6738.15))
				.balanceGoal(AccountBalanceGoal.create(474.91))
				.balanceLimit(AccountBalanceLimit.create(4860.45))
