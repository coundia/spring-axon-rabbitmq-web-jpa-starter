        ...
        TenantRepository tenantDataRepository,
		 User user) {
			...
			CreateAccountCommand command = CreateAccountCommand.builder()
				...
				.balance(AccountBalance.create(1000.19))
				.balancePrev(AccountBalancePrev.create(795.21))
				.balanceBlocked(AccountBalanceBlocked.create(9376.27))
				.balanceInit(AccountBalanceInit.create(5529.25))
				.balanceGoal(AccountBalanceGoal.create(7182.61))
				.balanceLimit(AccountBalanceLimit.create(7627.5))
