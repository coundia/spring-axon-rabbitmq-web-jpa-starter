...
void it_should_be_able_to_add_account() {
		...
		requestDTO.setBalance(6115.67);
		requestDTO.setBalancePrev(9636.26);
		requestDTO.setBalanceBlocked(618.58);
		requestDTO.setBalanceInit(5503.61);
		requestDTO.setBalanceGoal(8820.28);
		requestDTO.setBalanceLimit(1011.8);
