...
public class AccountUpdateControllerIntegrationTest extends BaseIntegrationTests {
    ...
    void it_should_be_able_to_update_account() {
        ...
        body.add("balance", 6361.12);
        body.add("balancePrev", 5209.82);
        body.add("balanceBlocked", 7018.22);
        body.add("balanceInit", 8665.09);
        body.add("balanceGoal", 8483.08);
        body.add("balanceLimit", 477.78);
