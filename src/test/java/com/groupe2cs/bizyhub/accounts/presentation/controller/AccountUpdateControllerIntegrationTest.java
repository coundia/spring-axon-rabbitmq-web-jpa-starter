...
public class AccountUpdateControllerIntegrationTest extends BaseIntegrationTests {
    ...
    void it_should_be_able_to_update_account() {
        ...
        body.add("balance", 4115.86);
        body.add("balancePrev", 844.29);
        body.add("balanceBlocked", 1262.27);
        body.add("balanceInit", 8572.37);
        body.add("balanceGoal", 9261.36);
        body.add("balanceLimit", 4573.4);
