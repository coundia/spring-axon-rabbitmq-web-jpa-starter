...
public class AccountUpdateControllerIntegrationTest extends BaseIntegrationTests {
    ...
    void it_should_be_able_to_update_account() {
        ...
        body.add("balance", 7721.64);
        body.add("balancePrev", 1815.93);
        body.add("balanceBlocked", 3560.01);
        body.add("balanceInit", 4458.58);
        body.add("balanceGoal", 2103.5);
        body.add("balanceLimit", 2796.59);
