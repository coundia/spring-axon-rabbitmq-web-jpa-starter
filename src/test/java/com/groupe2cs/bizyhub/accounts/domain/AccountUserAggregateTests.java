...
void it_should_create_accountUser_with_valid_values() {
	...
	AccountUserAggregate aggregateAccountUserAggregate = new AccountUserAggregate(id, name, account, user, syncAt, username, details, remoteId, localId, isActive, createdBy, tenant);
