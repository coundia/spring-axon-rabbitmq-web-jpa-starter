...
void it_should_create_accountUser_with_valid_values() {
	...
	AccountUserAggregate aggregateAccountUserAggregate = new AccountUserAggregate(id, name, account, user, username, details, isActive, updatedAt, reference, createdBy, tenant);
	...
	assertThat(aggregateAccountUserAggregate.getTenant()).isEqualTo(tenant);
		...
		AccountUserAccountNotValid error = assertThrows(AccountUserAccountNotValid.class, () -> AccountUserAccount.create(""));
		...
		AccountUserUsernameNotValid error = assertThrows(AccountUserUsernameNotValid.class, () -> AccountUserUsername.create(""));
		assertThat(error.getMessage()).isEqualTo("Username is invalid");
		}
		@Test
		void it_should_throw_when_details_is_invalid() {
		AccountUserDetailsNotValid error = assertThrows(AccountUserDetailsNotValid.class, () -> AccountUserDetails.create(""));
		...
		AccountUserUpdatedAtNotValid error = assertThrows(AccountUserUpdatedAtNotValid.class, () -> AccountUserUpdatedAt.create(null));
		assertThat(error.getMessage()).isEqualTo("UpdatedAt is invalid");
		}
		@Test
		void it_should_throw_when_reference_is_invalid() {
		AccountUserReferenceNotValid error = assertThrows(AccountUserReferenceNotValid.class, () -> AccountUserReference.create(""));
		assertThat(error.getMessage()).isEqualTo("Reference is invalid");
		}
		@Test
		void it_should_throw_when_createdBy_is_invalid() {
		AccountUserCreatedByNotValid error = assertThrows(AccountUserCreatedByNotValid.class, () -> AccountUserCreatedBy.create(""));
		assertThat(error.getMessage()).isEqualTo("CreatedBy is invalid");
		}
		@Test
		void it_should_throw_when_tenant_is_invalid() {
		AccountUserTenantNotValid error = assertThrows(AccountUserTenantNotValid.class, () -> AccountUserTenant.create(""));
