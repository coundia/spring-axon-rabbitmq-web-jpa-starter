...
public class CreateOrderCommandTest extends BaseUnitTests {
	...
	void it_should_send_command_to_command_gateway() {
		CreateOrderCommand command = new CreateOrderCommand(
				OrderId.create(UUID.randomUUID().toString()),
				OrderProductId.create(UUID.randomUUID().toString()),
				OrderUserId.create(UUID.randomUUID().toString()),
				OrderIdentifiant.create(UUID.randomUUID().toString()),
				OrderTelephone.create(UUID.randomUUID().toString()),
				OrderMail.create(UUID.randomUUID().toString()),
				OrderVille.create(UUID.randomUUID().toString()),
				OrderRemoteId.create(UUID.randomUUID().toString()),
				OrderLocalId.create(UUID.randomUUID().toString()),
				OrderStatus.create(UUID.randomUUID().toString()),
				OrderBuyerName.create(UUID.randomUUID().toString()),
				OrderAddress.create(UUID.randomUUID().toString()),
				OrderNotes.create(UUID.randomUUID().toString()),
				OrderMessage.create(UUID.randomUUID().toString()),
				OrderTypeOrder.create(UUID.randomUUID().toString()),
				OrderPaymentMethod.create(UUID.randomUUID().toString()),
				OrderDeliveryMethod.create(UUID.randomUUID().toString()),
				OrderAmountCents.create(3545.36),
				OrderQuantity.create(50),
				OrderDateCommand.create(java.time.Instant.now().plusSeconds(3600)),
				OrderCreatedBy.create(UUID.randomUUID().toString()),
				OrderTenant.create(UUID.randomUUID().toString())
		);
