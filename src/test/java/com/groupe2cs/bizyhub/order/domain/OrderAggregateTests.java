...
OrderAggregate aggregateOrderAggregate = new OrderAggregate(id, productId, userId, identifiant, telephone, mail, ville, remoteId, localId, status, buyerName, address, notes, message, typeOrder, paymentMethod, deliveryMethod, amountCents, quantity, dateCommand, createdBy, tenant);
