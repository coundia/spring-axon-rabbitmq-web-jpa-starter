...
public class CreateUnitCommandTest extends BaseUnitTests {
	...
	void it_should_send_command_to_command_gateway() {
		CreateUnitCommand command = new CreateUnitCommand(
				UnitId.create(UUID.randomUUID().toString()),
				UnitRemoteId.create(UUID.randomUUID().toString()),
				UnitLocalId.create(UUID.randomUUID().toString()),
				UnitCode.create(UUID.randomUUID().toString()),
				UnitName.create(UUID.randomUUID().toString()),
				UnitSyncAt.create(java.time.Instant.now().plusSeconds(3600)),
				UnitDescription.create(UUID.randomUUID().toString()),
				UnitCreatedBy.create(UUID.randomUUID().toString()),
				UnitTenant.create(UUID.randomUUID().toString())
		);
