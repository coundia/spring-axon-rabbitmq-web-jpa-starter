...
public class CustomerAggregateTests extends BaseUnitTests {
	...
	void it_should_create_customer_with_valid_values() {
		...
		CustomerAggregate
				aggregateCustomerAggregate =
				new CustomerAggregate(id,
						remoteId,
						localId,
						code,
						firstName,
	...
	void it_should_throw_when_balanceDebt_is_invalid() {
		CustomerBalanceDebtNotValid
				error =
				assertThrows(CustomerBalanceDebtNotValid.class, () -> CustomerBalanceDebt.create(null));
