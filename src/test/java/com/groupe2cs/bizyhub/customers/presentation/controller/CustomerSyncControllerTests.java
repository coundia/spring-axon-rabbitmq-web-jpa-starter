...
import com.groupe2cs.bizyhub.customers.application.dto.CustomerDeltaDto;
import com.groupe2cs.bizyhub.customers.application.dto.CustomerSyncRequest;
...
public class CustomerSyncControllerTests extends BaseIntegrationTests {
	...
	void it_should_initiate_update_of_customers() {
		...
		String
				existingId =
				CustomerFixtures.randomOneViaCommand(commandGateway, Repository, getCurrentUser()).getId().value();
