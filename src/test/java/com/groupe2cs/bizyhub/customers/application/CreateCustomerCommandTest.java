...
public class CreateCustomerCommandTest extends BaseUnitTests {
	...
	void it_should_send_command_to_command_gateway() {
		CreateCustomerCommand command = new CreateCustomerCommand(
				CustomerId.create(UUID.randomUUID().toString()),
				CustomerRemoteId.create(UUID.randomUUID().toString()),
				CustomerLocalId.create(UUID.randomUUID().toString()),
				CustomerCode.create(UUID.randomUUID().toString()),
				CustomerFirstName.create(UUID.randomUUID().toString()),
				CustomerLastName.create(UUID.randomUUID().toString()),
				CustomerFullName.create(UUID.randomUUID().toString()),
				CustomerBalance.create(9933.85),
				CustomerBalanceDebt.create(8042.22),
				CustomerPhone.create(UUID.randomUUID().toString()),
				CustomerEmail.create(UUID.randomUUID().toString()),
				CustomerNotes.create(UUID.randomUUID().toString()),
				CustomerStatus.create(UUID.randomUUID().toString()),
				CustomerAccount.create(UUID.randomUUID().toString()),
				CustomerCompany.create(UUID.randomUUID().toString()),
				CustomerAddressLine1.create(UUID.randomUUID().toString()),
				CustomerAddressLine2.create(UUID.randomUUID().toString()),
				CustomerCity.create(UUID.randomUUID().toString()),
				CustomerRegion.create(UUID.randomUUID().toString()),
				CustomerCountry.create(UUID.randomUUID().toString()),
				CustomerPostalCode.create(UUID.randomUUID().toString()),
				CustomerSyncAt.create(java.time.Instant.now().plusSeconds(3600)),
				CustomerIsActive.create(true),
				CustomerCreatedBy.create(UUID.randomUUID().toString()),
				CustomerTenant.create(UUID.randomUUID().toString())
		);
