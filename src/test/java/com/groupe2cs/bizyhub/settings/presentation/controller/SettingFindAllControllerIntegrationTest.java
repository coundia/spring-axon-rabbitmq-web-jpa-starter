...
SettingFixtures.randomManyViaCommand(commandGateway, 3, login("user", "user"));
...
List<CreateSettingCommand> userCommands =
SettingFixtures.randomManyViaCommand(commandGateway, 5, login("user", "user"));
userCommands.forEach(cmd ->
SettingFixtures.byIdWaitExist(settingRepository, cmd.getId().value())
);
...
SettingFixtures.randomManyViaCommand(commandGateway, 5, login("admin", "admin"));
