...
CreateSettingCommand command = new CreateSettingCommand(
 SettingId.create(UUID.randomUUID().toString()) ,  SettingName.create(UUID.randomUUID().toString()) ,  SettingReference.create(UUID.randomUUID().toString()) ,  SettingUpdatedAt.create(java.time.Instant.now().plusSeconds(3600)) ,  SettingStringValue.create(UUID.randomUUID().toString()) ,  SettingDescriptions.create(UUID.randomUUID().toString()) ,  SettingIsActive.create(true) ,  SettingCreatedBy.create(UUID.randomUUID().toString()) ,  SettingTenant.create(UUID.randomUUID().toString()) 
);
