...
ProductAggregate aggregateProductAggregate = new ProductAggregate(id, remoteId, localId, code, name, description, status, isPublic, hasSold, hasPrice, level, quantity, barcode, company, unit, syncAt, category, account, defaultPrice, statuses, purchasePrice, createdBy, tenant);
