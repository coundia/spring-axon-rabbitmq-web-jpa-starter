...
import com.groupe2cs.bizyhub.transactions.application.dto.TransactionItemDeltaDto;
...
public class TransactionItemSyncControllerTests extends BaseIntegrationTests {
	...
	void it_should_initiate_update_of_transactionItems() {
		...
		String
				existingId =
				TransactionItemFixtures.randomOneViaCommand(commandGateway, Repository, getCurrentUser()).getId()
						.value();
