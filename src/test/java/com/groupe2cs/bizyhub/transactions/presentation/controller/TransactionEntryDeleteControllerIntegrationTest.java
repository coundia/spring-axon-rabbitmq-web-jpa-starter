...
public class TransactionEntryDeleteControllerIntegrationTest extends BaseIntegrationTests {
...
@Test
void it_should_be_able_to_delete_transactionentry() {
	String existingId = TransactionEntryFixtures.randomOneViaCommand(commandGateway, transactionentryRepository,
	...
	String uri = "/v1/commands/transactionEntry/" + existingId;

	ResponseEntity<String> rep = this.delete(uri);
	assertThat(rep.getStatusCode().value()).isEqualTo(200);

	TransactionEntry found = TransactionEntryFixtures.byIdWaitNotExist(transactionentryRepository, existingId);
