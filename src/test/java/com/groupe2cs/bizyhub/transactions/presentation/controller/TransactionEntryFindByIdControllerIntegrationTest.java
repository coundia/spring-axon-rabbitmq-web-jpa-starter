...
public class TransactionEntryFindByIdControllerIntegrationTest extends BaseIntegrationTests {
...
@Test
void it_should_be_able_to_get_transactionentry_by_id() {
	...
	commandGateway,repository,
	 ...
	 TransactionEntryFixtures.byIdWaitExist(repository, existingId);

	String uri = "/v1/queries/transactionEntry/id?id=" + existingId;
	ResponseEntity<TransactionEntryResponse> response = this.getForEntity(uri, TransactionEntryResponse.class);
