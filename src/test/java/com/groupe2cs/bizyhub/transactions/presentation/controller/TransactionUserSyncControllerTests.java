...
import com.groupe2cs.bizyhub.transactions.application.dto.TransactionUserDeltaDto;
...
public class TransactionUserSyncControllerTests extends BaseIntegrationTests {
		...
		TransactionUserSyncRequest requestDTO = TransactionUserSyncRequest.builder()
				.deltas(List.of(
						TransactionUserDeltaDto.builder()
								...
								.transaction(com.groupe2cs.bizyhub.transactions.infrastructure.entity.TransactionFixtures.randomOneViaCommand(
										commandGateway,
										transactionDataRepository,
										user).getId().value())
	...
	void it_should_initiate_update_of_transactionUsers() {
		...
		String
				existingId =
				TransactionUserFixtures.randomOneViaCommand(commandGateway, Repository, getCurrentUser()).getId()
						.value();
