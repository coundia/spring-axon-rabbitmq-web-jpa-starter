...
public class TransactionUserFixtures {
	...
	public static CreateTransactionUserCommand randomOneViaCommand(
		...
		CreateTransactionUserCommand command = CreateTransactionUserCommand.builder()
				...
				.transaction(TransactionUserTransaction.create(com.groupe2cs.bizyhub.transactions.infrastructure.entity.TransactionFixtures.randomOneViaCommand(
						commandGateway,
						transactionDataRepository,
						user).getId().value()))
				.user(TransactionUserUser.create(com.groupe2cs.bizyhub.security.infrastructure.entity.UserFixtures.randomOneViaCommand(
						commandGateway,
						userDataRepository,
						user).getId().value()))
