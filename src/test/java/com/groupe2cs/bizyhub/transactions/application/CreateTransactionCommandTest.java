...
CreateTransactionCommand command = new CreateTransactionCommand(
 TransactionId.create(UUID.randomUUID().toString()) ,  TransactionReference.create(UUID.randomUUID().toString()) ,  TransactionAmount.create(5005.02) 
);
...
TransactionCreatedEvent event = new TransactionCreatedEvent( TransactionId.create(UUID.randomUUID().toString()),  TransactionReference.create(UUID.randomUUID().toString()),  TransactionAmount.create(5005.02));
