...
public class CreateTransactionUserCommandTest extends BaseUnitTests {
	...
	void it_should_send_command_to_command_gateway() {
		CreateTransactionUserCommand command = new CreateTransactionUserCommand(
				...
				TransactionUserIsActive.create(false),
				TransactionUserUpdatedAt.create(java.time.Instant.now().plusSeconds(3600)),
				TransactionUserReference.create(UUID.randomUUID().toString()),
