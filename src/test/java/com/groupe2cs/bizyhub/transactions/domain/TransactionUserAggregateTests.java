...
public class TransactionUserAggregateTests extends BaseUnitTests {
	...
	void it_should_create_transactionUser_with_valid_values() {
		...
		TransactionUserAggregate
				aggregateTransactionUserAggregate =
				new TransactionUserAggregate(id,
						name,
						transaction,
						user,
						username,
	...
	void it_should_throw_when_id_is_invalid() {
		TransactionUserIdNotValid
				error =
				assertThrows(TransactionUserIdNotValid.class, () -> TransactionUserId.create(""));
		assertThat(error.getMessage()).isEqualTo("Id is invalid");
	}

	@Test
	void it_should_throw_when_name_is_invalid() {
		TransactionUserNameNotValid
				error =
				assertThrows(TransactionUserNameNotValid.class, () -> TransactionUserName.create(""));
		assertThat(error.getMessage()).isEqualTo("Name is invalid");
	}

	@Test
	void it_should_throw_when_transaction_is_invalid() {
		TransactionUserTransactionNotValid
				error =
				assertThrows(TransactionUserTransactionNotValid.class, () -> TransactionUserTransaction.create(""));
		assertThat(error.getMessage()).isEqualTo("Transaction is invalid");
	}

	@Test
	void it_should_throw_when_user_is_invalid() {
		TransactionUserUserNotValid
				error =
				assertThrows(TransactionUserUserNotValid.class, () -> TransactionUserUser.create(""));
		assertThat(error.getMessage()).isEqualTo("User is invalid");
	}

	@Test
	void it_should_throw_when_username_is_invalid() {
		TransactionUserUsernameNotValid
				error =
				assertThrows(TransactionUserUsernameNotValid.class, () -> TransactionUserUsername.create(""));
		assertThat(error.getMessage()).isEqualTo("Username is invalid");
	}

	@Test
	void it_should_throw_when_details_is_invalid() {
		TransactionUserDetailsNotValid
				error =
				assertThrows(TransactionUserDetailsNotValid.class, () -> TransactionUserDetails.create(""));
		assertThat(error.getMessage()).isEqualTo("Details is invalid");
	}

	@Test
	void it_should_throw_when_isActive_is_invalid() {
		TransactionUserIsActiveNotValid
				error =
				assertThrows(TransactionUserIsActiveNotValid.class, () -> TransactionUserIsActive.create(null));
		assertThat(error.getMessage()).isEqualTo("IsActive is invalid");
	}

	@Test
	void it_should_throw_when_updatedAt_is_invalid() {
		TransactionUserUpdatedAtNotValid
				error =
				assertThrows(TransactionUserUpdatedAtNotValid.class, () -> TransactionUserUpdatedAt.create(null));
		assertThat(error.getMessage()).isEqualTo("UpdatedAt is invalid");
	}

	@Test
	void it_should_throw_when_reference_is_invalid() {
		TransactionUserReferenceNotValid
				error =
				assertThrows(TransactionUserReferenceNotValid.class, () -> TransactionUserReference.create(""));
		assertThat(error.getMessage()).isEqualTo("Reference is invalid");
	}

	@Test
	void it_should_throw_when_createdBy_is_invalid() {
		TransactionUserCreatedByNotValid
				error =
				assertThrows(TransactionUserCreatedByNotValid.class, () -> TransactionUserCreatedBy.create(""));
		assertThat(error.getMessage()).isEqualTo("CreatedBy is invalid");
	}

	@Test
	void it_should_throw_when_tenant_is_invalid() {
		TransactionUserTenantNotValid
				error =
				assertThrows(TransactionUserTenantNotValid.class, () -> TransactionUserTenant.create(""));
