...
public class TransactionAggregateTests extends BaseUnitTests {
	...
	void it_should_create_transaction_with_valid_values() {
		...
		TransactionAmount amount = TransactionAmount.create(1615.49);
	...
	void it_should_throw_when_details_is_invalid() {
		TransactionDetailsNotValid
				error =
				assertThrows(TransactionDetailsNotValid.class, () -> TransactionDetails.create(""));
	...
	void it_should_throw_when_account_is_invalid() {
		TransactionAccountNotValid
				error =
				assertThrows(TransactionAccountNotValid.class, () -> TransactionAccount.create(""));
	...
	void it_should_throw_when_typeTransactionRaw_is_invalid() {
		TransactionTypeTransactionRawNotValid
				error =
				assertThrows(TransactionTypeTransactionRawNotValid.class,
						() -> TransactionTypeTransactionRaw.create(""));
		assertThat(error.getMessage()).isEqualTo("TypeTransactionRaw is invalid");
	}

	@Test
	void it_should_throw_when_dateTransaction_is_invalid() {
		TransactionDateTransactionNotValid
				error =
				assertThrows(TransactionDateTransactionNotValid.class, () -> TransactionDateTransaction.create(null));
