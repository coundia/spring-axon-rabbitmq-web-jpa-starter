...
public class TransactionAggregateTests extends BaseUnitTests {
	...
	void it_should_create_transaction_with_valid_values() {
		...
		TransactionAmount amount = TransactionAmount.create(1766.18);
		TransactionDateOperation
				dateOperation =
				TransactionDateOperation.create(java.time.Instant.now().plusSeconds(3600));
		...
		TransactionIsRecurring isRecurring = TransactionIsRecurring.create(false);
		TransactionIsExcluToRapport isExcluToRapport = TransactionIsExcluToRapport.create(false);
	...
	void it_should_throw_when_dateOperation_is_invalid() {
		TransactionDateOperationNotValid
				error =
				assertThrows(TransactionDateOperationNotValid.class, () -> TransactionDateOperation.create(null));
		assertThat(error.getMessage()).isEqualTo("DateOperation is invalid");
	}

	@Test
	void it_should_throw_when_description_is_invalid() {
		TransactionDescriptionNotValid
				error =
				assertThrows(TransactionDescriptionNotValid.class, () -> TransactionDescription.create(""));
	...
	void it_should_throw_when_isRecurring_is_invalid() {
		TransactionIsRecurringNotValid
				error =
				assertThrows(TransactionIsRecurringNotValid.class, () -> TransactionIsRecurring.create(null));
		assertThat(error.getMessage()).isEqualTo("IsRecurring is invalid");
	}

	@Test
	void it_should_throw_when_isExcluToRapport_is_invalid() {
		TransactionIsExcluToRapportNotValid
				error =
				assertThrows(TransactionIsExcluToRapportNotValid.class, () -> TransactionIsExcluToRapport.create(null));
		assertThat(error.getMessage()).isEqualTo("IsExcluToRapport is invalid");
	}

	@Test
	void it_should_throw_when_status_is_invalid() {
		TransactionStatusNotValid
				error =
				assertThrows(TransactionStatusNotValid.class, () -> TransactionStatus.create(""));
		assertThat(error.getMessage()).isEqualTo("Status is invalid");
	}

	@Test
	void it_should_throw_when_balance_is_invalid() {
		TransactionBalanceNotValid
				error =
				assertThrows(TransactionBalanceNotValid.class, () -> TransactionBalance.create(""));
		assertThat(error.getMessage()).isEqualTo("Balance is invalid");
	}

	@Test
	void it_should_throw_when_category_is_invalid() {
		TransactionCategoryNotValid
				error =
				assertThrows(TransactionCategoryNotValid.class, () -> TransactionCategory.create(""));
		assertThat(error.getMessage()).isEqualTo("Category is invalid");
	}

	@Test
	void it_should_throw_when_updatedAt_is_invalid() {
		TransactionUpdatedAtNotValid
				error =
				assertThrows(TransactionUpdatedAtNotValid.class, () -> TransactionUpdatedAt.create(null));
		assertThat(error.getMessage()).isEqualTo("UpdatedAt is invalid");
	}

	@Test
	void it_should_throw_when_createdAt_is_invalid() {
		TransactionCreatedAtNotValid
				error =
				assertThrows(TransactionCreatedAtNotValid.class, () -> TransactionCreatedAt.create(null));
