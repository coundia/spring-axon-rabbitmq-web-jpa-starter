...
public class TransactionAggregateTests extends BaseUnitTests {
	...
	void it_should_create_transaction_with_valid_values() {
		...
		TransactionAmount amount = TransactionAmount.create(8135.13);
	...
	void it_should_throw_when_typeEntry_is_invalid() {
		TransactionTypeEntryNotValid
				error =
				assertThrows(TransactionTypeEntryNotValid.class, () -> TransactionTypeEntry.create(""));
