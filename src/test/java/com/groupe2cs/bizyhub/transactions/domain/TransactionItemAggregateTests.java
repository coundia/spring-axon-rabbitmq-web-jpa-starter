...
void it_should_create_transactionItem_with_valid_values() {
	...
	TransactionItemQuantity quantity = TransactionItemQuantity.create(77);
	...
	TransactionItemUnitPrice unitPrice = TransactionItemUnitPrice.create(534.7);
	TransactionItemTotal total = TransactionItemTotal.create(1694.38);
	...
	TransactionItemAggregate aggregateTransactionItemAggregate = new TransactionItemAggregate(id, transaction, product, label, quantity, unit, syncAt, unitPrice, total, notes, createdBy, tenant);
