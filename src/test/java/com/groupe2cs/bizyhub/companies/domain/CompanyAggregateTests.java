...
CompanyAggregate aggregateCompanyAggregate = new CompanyAggregate(id, remoteId, localId, code, name, description, phone, email, website, taxId, currency, addressLine1, addressLine2, city, region, country, account, postalCode, isActive, status, isPublic, syncAt, isDefault, createdBy, tenant);
	...
	assertThat(aggregateCompanyAggregate.getTenant()).isEqualTo(tenant);
		...
		CompanyIsDefaultNotValid error = assertThrows(CompanyIsDefaultNotValid.class, () -> CompanyIsDefault.create(null));
