...
public class CreateCompanyCommandTest extends BaseUnitTests {
	...
	void it_should_send_command_to_command_gateway() {
		CreateCompanyCommand command = new CreateCompanyCommand(
				CompanyId.create(UUID.randomUUID().toString()),
				CompanyRemoteId.create(UUID.randomUUID().toString()),
				CompanyLocalId.create(UUID.randomUUID().toString()),
				CompanyCode.create(UUID.randomUUID().toString()),
				CompanyName.create(UUID.randomUUID().toString()),
				CompanyDescription.create(UUID.randomUUID().toString()),
				CompanyPhone.create(UUID.randomUUID().toString()),
				CompanyEmail.create(UUID.randomUUID().toString()),
				CompanyWebsite.create(UUID.randomUUID().toString()),
				CompanyTaxId.create(UUID.randomUUID().toString()),
				CompanyCurrency.create(UUID.randomUUID().toString()),
				CompanyAddressLine1.create(UUID.randomUUID().toString()),
				CompanyAddressLine2.create(UUID.randomUUID().toString()),
				CompanyCity.create(UUID.randomUUID().toString()),
				CompanyRegion.create(UUID.randomUUID().toString()),
				CompanyCountry.create(UUID.randomUUID().toString()),
				CompanyAccount.create(UUID.randomUUID().toString()),
				CompanyPostalCode.create(UUID.randomUUID().toString()),
				CompanyIsActive.create(false),
				CompanyStatus.create(UUID.randomUUID().toString()),
				CompanyIsPublic.create(true),
				CompanySyncAt.create(java.time.Instant.now().plusSeconds(3600)),
				CompanyIsDefault.create(true),
				CompanyCreatedBy.create(UUID.randomUUID().toString()),
				CompanyTenant.create(UUID.randomUUID().toString())
		);
